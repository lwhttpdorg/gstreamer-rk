...
/**
 * gst_pad_set_task:
 * @pad: the #GstPad to set the task to
 * @task: the #GstPad to set
 *
 * Sets a task to a GstPad. This function must be used only during task
 * creation on GST_STREAM_STATUS_TYPE_CREATE.
 *
 * Returns: a %TRUE if the task could be set.
 *
 * Since: 1.28
 */
gboolean
