    ...
    GstPlugin * ref_plugin, const gchar * full_filename)
{
  ...
  features =
      __gst_registry_get_features_for_plugin (ref_plugin->priv->registry,
      ref_plugin, TRUE);
...
void
__gst_registry_create_static_caches (const gchar ** plugin_paths,
    GError ** out_err)
{
...
GList *
__gst_registry_get_features_for_plugin (GstRegistry * registry,
