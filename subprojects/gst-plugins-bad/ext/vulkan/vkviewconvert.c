    ...
    GstPadDirection direction, GstCaps * caps, GstCaps * othercaps)
{
  ...
  result =
      gst_video_convertscale_fixate_caps (GST_OBJECT (viewconvert), direction,
  ...
  GST_DEBUG_OBJECT (viewconvert,
      "dir %s fixated to %" GST_PTR_FORMAT " against caps %" GST_PTR_FORMAT,
      direction == GST_PAD_SINK ? "sink" : "src", result, caps);
