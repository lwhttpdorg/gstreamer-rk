...
{
  return gst_d3d12_caps_remove_format_info (caps);
}

static GstCaps *
gst_d3d12_base_convert_caps_rangify_size_info (GstCaps * caps)
{
  return gst_d3d12_caps_rangify_size_info (caps);
}

static GstCaps *
gst_d3d12_base_convert_caps_remove_format_and_rangify_size_info (GstCaps * caps)
{
  return gst_d3d12_caps_remove_format_and_rangify_size_info (caps);
}
...
{
  gst_d3d12_video_format_score_value (in_info, val, min_loss, out_info);
}
