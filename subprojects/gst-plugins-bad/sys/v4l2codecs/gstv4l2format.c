...
#define AFBC_DRM(drm_fmt, block_size, flags) \
  DRM_FORMAT_##drm_fmt, DRM_FORMAT_MOD_ARM_AFBC(AFBC_FORMAT_MOD_BLOCK_SIZE_##block_size | flags)
...
static const GstV4l2FormatDesc gst_v4l2_descriptions[] = {
  ...
  {V4L2_PIX_FMT_AFBC_YUV420_16x16_SPLIT,    GST_VIDEO_FORMAT_UNKNOWN,     AFBC_DRM(YUV420_8BIT, 16x16, AFBC_FORMAT_MOD_SPARSE | AFBC_FORMAT_MOD_SPLIT),   1},
  {V4L2_PIX_FMT_AFBC_YUV420_32x8,     GST_VIDEO_FORMAT_UNKNOWN,     AFBC_DRM(YUV420_8BIT, 32x8, AFBC_FORMAT_MOD_SPARSE),    1},
  {V4L2_PIX_FMT_AFBC_YUV420_16x16_10_SPLIT, GST_VIDEO_FORMAT_UNKNOWN,     AFBC_DRM(YUV420_10BIT, 16x16, AFBC_FORMAT_MOD_SPARSE | AFBC_FORMAT_MOD_SPLIT),  1},
  {V4L2_PIX_FMT_AFBC_YUV420_32x8_10,  GST_VIDEO_FORMAT_UNKNOWN,     AFBC_DRM(YUV420_10BIT, 32x8, AFBC_FORMAT_MOD_SPARSE),   1},
};
/* *INDENT-ON* */
