...
/**
 * gst_h264_sps_get_profile_string:
 * @sps: a #GstH264SPS
 *
 * Returns the descriptive profile name for the H.264 SPS based on
 * profile_idc and constraint flags.
 *
 * Returns: (nullable): the profile name for @sps or %NULL on error
 *
 * Since: 1.28
 */
const gchar *
gst_h264_sps_get_profile_string (const GstH264SPS * sps)
{
