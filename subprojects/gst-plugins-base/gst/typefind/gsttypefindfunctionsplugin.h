...
GST_TYPE_FIND_REGISTER_DECLARE (heif);
GST_TYPE_FIND_REGISTER_DECLARE (heif_seq);
GST_TYPE_FIND_REGISTER_DECLARE (heic);
GST_TYPE_FIND_REGISTER_DECLARE (heic_seq);
GST_TYPE_FIND_REGISTER_DECLARE (avif);
