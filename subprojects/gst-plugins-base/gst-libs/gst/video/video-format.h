 ...
 * @GST_VIDEO_FORMAT_P210_BE: planar 4:2:2 YUV with interleaved UV plane, 10 bits per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_P210_LE: planar 4:2:2 YUV with interleaved UV plane, 10 bits per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_P212_BE: planar 4:2:2 YUV with interleaved UV plane, 12 bits per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_P212_LE: planar 4:2:2 YUV with interleaved UV plane, 12 bits per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_P216_BE: planar 4:2:2 YUV with interleaved UV plane, 16 bits per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_P216_LE: planar 4:2:2 YUV with interleaved UV plane, 16 bits per channel (Since: 1.30)
 *
...
typedef enum {
  ...
  /**
   * GST_VIDEO_FORMAT_P210_10BE:
   *
   * planar 4:2:2 YUV with interleaved UV plane, 10 bits per channel.
   *
   * Since: 1.30
   */
  GST_VIDEO_FORMAT_P210_10BE,
  ...
  /**
   * GST_VIDEO_FORMAT_P212_BE:
   *
   * planar 4:2:2 YUV with interleaved UV plane, 12 bits per channel.
   *
   * Since: 1.30
   */
  GST_VIDEO_FORMAT_P212_BE,
  ...
  /**
   * GST_VIDEO_FORMAT_P216_BE:
   *
   * planar 4:2:2 YUV with interleaved UV plane, 16 bits per channel.
   *
   * Since: 1.30
   */
  GST_VIDEO_FORMAT_P216_BE,
 ...
 * Since: 1.26
 */
#define GST_VIDEO_FORMAT_LAST (GST_VIDEO_FORMAT_P216_LE + 1)
...
#define GST_VIDEO_FORMATS_ALL_STR "A444_16BE, A444_16LE, AYUV64, ARGB64, " \
    ...
    "P216_BE, P216_LE, Y216_BE, v216, Y216_LE, P016_BE, P016_LE, Y444_12BE, " \
    "GBR_12BE, Y444_12LE, GBR_12LE, I422_12BE, I422_12LE, P212_BE, P212_LE, " \
    "Y212_BE, Y212_LE, I420_12BE, I420_12LE, P012_BE, P012_LE, Y444_10BE, " \
    "GBR_10BE, Y444_10LE, GBR_10LE, r210, BGR10x2_LE, RGB10x2_LE, I422_10BE, " \
    "I422_10LE, P210_10BE, P210_10LE, NV16_10LE40, NV16_10LE32, Y210, UYVP, " \
...
#define GST_VIDEO_FORMATS_ALL_STR "A444_16LE, A444_16BE, Y416_LE, AYUV64, " \
    ...
    "P216_LE, P216_BE, Y216_LE, Y216_BE, v216, P016_LE, P016_BE, Y444_12LE, " \
    "GBR_12LE, Y444_12BE, GBR_12BE, I422_12LE, I422_12BE, P212_LE, P212_BE, " \
    "Y212_LE, Y212_BE, I420_12LE, I420_12BE, P012_LE, P012_BE, Y444_10LE, " \
    "GBR_10LE, Y444_10BE, GBR_10BE, BGR10x2_LE, RGB10x2_LE, r210, I422_10LE, " \
    "I422_10BE, P210_10LE, NV16_10LE40, NV16_10LE32, P210_10BE, Y210, UYVP, " \
    "v210, I420_10LE, I420_10BE, P010_10LE, NV12_10LE40, NV12_10LE32, P010_10BE, MT2110R, " \
