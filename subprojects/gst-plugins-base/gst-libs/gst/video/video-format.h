 ...
 * @GST_VIDEO_FORMAT_GENERIC: Parametric generic video format described by extended GstVideoInfo parameters (Since: 1.30)
 *
 ...
 * Since: 1.26
 */
#define GST_VIDEO_FORMAT_LAST (GST_VIDEO_FORMAT_GENERIC + 1)
