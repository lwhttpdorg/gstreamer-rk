...
static const struct FormatMap
{
  ...
  {GST_VIDEO_FORMAT_NV12_128C8, DRM_FORMAT_NV12, DRM_FORMAT_MOD_BROADCOM_SAND128},
  {GST_VIDEO_FORMAT_NV12_10LE32_128C8, DRM_FORMAT_P030, DRM_FORMAT_MOD_BROADCOM_SAND128},
};
/* *INDENT-ON* */
