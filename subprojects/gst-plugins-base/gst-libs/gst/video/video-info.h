 ...
 * gst_video_frame_map().
 *
 * For %GST_VIDEO_FORMAT_PARAMETRIC formats, the structure carries an opaque
 ...
 * Use gst_video_info_get_parametric_params() to retrieve the parametric
 * description for %GST_VIDEO_FORMAT_PARAMETRIC formats.
 *
...
GST_VIDEO_API
const GstVideoParametricParams * gst_video_info_get_parametric_params (const GstVideoInfo *info);
