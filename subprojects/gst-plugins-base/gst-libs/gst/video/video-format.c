...
#define PACK_P216_BE GST_VIDEO_FORMAT_AYUV64, unpack_P216_BE, 1, pack_P216_BE
static void
unpack_P216_BE (const GstVideoFormatInfo * info, GstVideoPackFlags flags,
    gpointer dest, const gpointer data[GST_VIDEO_MAX_PLANES],
    const gint stride[GST_VIDEO_MAX_PLANES], gint x, gint y, gint width)
{
  int i;
...
static void
pack_P216_BE (const GstVideoFormatInfo * info, GstVideoPackFlags flags,
    const gpointer src, gint sstride, gpointer data[GST_VIDEO_MAX_PLANES],
    const gint stride[GST_VIDEO_MAX_PLANES], GstVideoChromaSite chroma_site,
    gint y, gint width)
{
...
#define PACK_P216_LE GST_VIDEO_FORMAT_AYUV64, unpack_P216_LE, 1, pack_P216_LE
static void
unpack_P216_LE (const GstVideoFormatInfo * info, GstVideoPackFlags flags,
    gpointer dest, const gpointer data[GST_VIDEO_MAX_PLANES],
    const gint stride[GST_VIDEO_MAX_PLANES], gint x, gint y, gint width)
{
  int i;
...
static void
pack_P216_LE (const GstVideoFormatInfo * info, GstVideoPackFlags flags,
    const gpointer src, gint sstride, gpointer data[GST_VIDEO_MAX_PLANES],
    const gint stride[GST_VIDEO_MAX_PLANES], GstVideoChromaSite chroma_site,
    gint y, gint width)
{
...
#define PACK_P212_BE GST_VIDEO_FORMAT_AYUV64, unpack_P212_BE, 1, pack_P212_BE
static void
unpack_P212_BE (const GstVideoFormatInfo * info, GstVideoPackFlags flags,
    gpointer dest, const gpointer data[GST_VIDEO_MAX_PLANES],
    const gint stride[GST_VIDEO_MAX_PLANES], gint x, gint y, gint width)
{
  int i;
...
static void
pack_P212_BE (const GstVideoFormatInfo * info, GstVideoPackFlags flags,
    const gpointer src, gint sstride, gpointer data[GST_VIDEO_MAX_PLANES],
    const gint stride[GST_VIDEO_MAX_PLANES], GstVideoChromaSite chroma_site,
    gint y, gint width)
{
...
#define PACK_P210_BE GST_VIDEO_FORMAT_AYUV64, unpack_P210_10BE, 1, pack_P210_10BE
static void
unpack_P210_10BE (const GstVideoFormatInfo * info, GstVideoPackFlags flags,
    gpointer dest, const gpointer data[GST_VIDEO_MAX_PLANES],
    const gint stride[GST_VIDEO_MAX_PLANES], gint x, gint y, gint width)
{
  int i;
...
static void
pack_P210_10BE (const GstVideoFormatInfo * info, GstVideoPackFlags flags,
    const gpointer src, gint sstride, gpointer data[GST_VIDEO_MAX_PLANES],
    const gint stride[GST_VIDEO_MAX_PLANES], GstVideoChromaSite chroma_site,
    gint y, gint width)
{
...
#define PACK_P210_LE GST_VIDEO_FORMAT_AYUV64, unpack_P210_10LE, 1, pack_P210_10LE
static void
...
static const VideoFormat formats[] = {
  ...
  MAKE_RGB_LE_FORMAT (RGB10x2_LE, "raw video", DPTH10_10_10, PSTR444,
      PLANE0, OFFS0, SUB4444, PACK_RGB10A2_LE),
  MAKE_YUV_FORMAT (P210_10BE, "raw video", 0x00000000, DPTH10_10_10,
      PSTR244, PLANE011, OFFS001, SUB422, PACK_P210_BE),
  MAKE_YUV_LE_FORMAT (P210_10LE, "raw video", 0x00000000, DPTH10_10_10,
      PSTR244, PLANE011, OFFS001, SUB422, PACK_P210_LE),
  MAKE_YUV_FORMAT (P212_BE, "raw video", 0x00000000, DPTH12_12_12,
      PSTR244, PLANE011, OFFS001, SUB422, PACK_P212_BE),
  MAKE_YUV_LE_FORMAT (P212_LE, "raw video", 0x00000000, DPTH12_12_12,
      PSTR244, PLANE011, OFFS001, SUB422, PACK_P212_LE),
  MAKE_YUV_FORMAT (P216_BE, "raw video", 0x00000000, DPTH16_16_16,
      PSTR244, PLANE011, OFFS001, SUB422, PACK_P216_BE),
  MAKE_YUV_LE_FORMAT (P216_LE, "raw video", 0x00000000, DPTH16_16_16,
      PSTR244, PLANE011, OFFS001, SUB422, PACK_P216_LE),
};
