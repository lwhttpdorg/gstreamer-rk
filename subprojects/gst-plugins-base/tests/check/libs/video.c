...
/* Integer pack/unpack round-trips for interleaved and planar PARAMETRIC formats. */
GST_START_TEST (test_video_format_parametric_pack_unpack)
{
  static const GenericCompDef rgb8[] = {
    {"red", 8, "unsigned-int", 0},
    {"green", 8, "unsigned-int", 0},
  ...
  caps = make_parametric_caps (4, 1, rgb8, 3, 0, "interleave", 0, 0, 1, 1);
  fail_unless (gst_video_info_init_from_caps_extended (&info, caps));

  unpack_fmt = gst_video_format_parametric_get_unpack_format (&info);
...

  {
    ...
    fail_unless (gst_video_format_parametric_unpack (&info,
    ...
    fail_unless (gst_video_format_parametric_pack (&info,
  ...
  caps = make_parametric_caps (4, 1, rgb10, 3, 0, "interleave", 0, 0, 1, 1);
  ...
  caps = make_parametric_caps (4, 1, ycbcr8, 3, 0, "component", 0, 0, 1, 1);
  fail_unless (gst_video_info_init_from_caps_extended (&info, caps));
...
GST_START_TEST (test_video_format_parametric_frame_unpack)
{
  static const GenericCompDef rgb8[] = {
    {"red", 8, "unsigned-int", 0},
    {"green", 8, "unsigned-int", 0},
  ...
  caps = make_parametric_caps (2, 1, rgb8, G_N_ELEMENTS (rgb8),
      0, "interleave", 0, 0, 1, 1);
  fail_unless (gst_video_info_init_from_caps_extended (&info, caps));
  gst_caps_unref (caps);
...

  {
    ...
    fail_unless (gst_video_format_parametric_unpack (&frame.info,
            GST_VIDEO_PACK_FLAG_NONE, unpacked,
...
video_suite (void)
{
  ...
  tcase_add_test (tc_chain, test_video_format_parametric_pack_unpack);
  ...
  tcase_add_test (tc_chain, test_video_format_parametric_frame_unpack);
