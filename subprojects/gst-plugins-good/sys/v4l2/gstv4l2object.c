...
#define AFBC_DRM(drm_fmt, block_size, flags) \
  DRM_FORMAT_##drm_fmt, DRM_FORMAT_MOD_ARM_AFBC(AFBC_FORMAT_MOD_BLOCK_SIZE_##block_size | AFBC_FORMAT_MOD_SPARSE)
...
static GstV4L2FormatDesc gst_v4l2_formats[] = {
  ...
  /* AFBC formats */
  {MAP_FMT(AFBC_YUV420_16x16_SPLIT, UNKNOWN),     AFBC_DRM(YUV420_8BIT, 16x16, AFBC_FORMAT_MOD_SPARSE | AFBC_FORMAT_MOD_SPLIT),   GST_V4L2_RAW},
  {MAP_FMT(AFBC_YUV420_32x8, UNKNOWN),      AFBC_DRM(YUV420_8BIT, 32x8, AFBC_FORMAT_MOD_SPARSE),    GST_V4L2_RAW},
  {MAP_FMT(AFBC_YUV420_16x16_10_SPLIT, UNKNOWN),  AFBC_DRM(YUV420_10BIT, 16x16, AFBC_FORMAT_MOD_SPARSE | AFBC_FORMAT_MOD_SPLIT),  GST_V4L2_RAW},
  {MAP_FMT(AFBC_YUV420_32x8_10, UNKNOWN),   AFBC_DRM(YUV420_10BIT, 32x8, AFBC_FORMAT_MOD_SPARSE),   GST_V4L2_RAW},
};
#undef MAP_FMT
/* *INDENT-ON* */
