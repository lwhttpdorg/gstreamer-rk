...
#define GST_TYPE_RTP_SPEEX_DEPAY (gst_rtp_speex_depay_get_type())
G_DECLARE_FINAL_TYPE (GstRtpSPEEXDepay, gst_rtp_speex_depay,
    GST, RTP_SPEEX_DEPAY, GstRTPBaseDepayload)
