...
FLUSTER_FLAKES=$INSTALL/fluster/$CPU_VERSION-fluster-flakes.txt
touch ${FLUSTER_FLAKES}

# Default to an empty known fails file if it doesn't exist.
FLUSTER_FAILS=$INSTALL/fluster/$CPU_VERSION-fluster-fails.txt
touch ${FLUSTER_FAILS}

# Default to an empty known skips file if it doesn't exist.
FLUSTER_SKIPS=$INSTALL/fluster/$CPU_VERSION-fluster-skips.txt
touch ${FLUSTER_SKIPS}
