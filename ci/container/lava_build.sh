...
############### Build dEQP runner
# Note: Currently setting the git rev to have fluster support (include a fix)
# Use a version tag in ci/container/build-deqp-runner.sh when one is available.
export DEQP_RUNNER_GIT_REV=76b761965c52c2b0552f8a4c17eae0323cbae30f
...
./fluster.py download JCT-VC-HEVC_V1 JCT-VC-SCC JCT-VC-RExt JCT-VC-MV-HEVC JVT-AVC_V1 JVT-FR-EXT VP9-TEST-VECTORS VP9-TEST-VECTORS-HIGH VP8-TEST-VECTORS
popd
